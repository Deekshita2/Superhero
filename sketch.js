...
function setup() {
  ...
  box11 = new Box(900,500,70,70);
  box12 = new Box(900,600,70,70);

  box13 = new Box(750,100,70,70);
  box14 = new Box(750,200,70,70);
  box15 = new Box(750,300,70,70);
  
  box16 = new Box(750,400,70,70);
  box17 = new Box(750,500,70,70);
  box18 = new Box(750,600,70,70)
